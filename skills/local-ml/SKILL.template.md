---
name: local-ml
description: "Run local AI models with no API key. Use to remove image backgrounds, detect or describe objects, transcribe audio, or embed and classify text."
---
