...
- **What this proposes.** Two or three sentences: what changes, for whom, and what the frames are meant to settle. Someone who reads only this and looks only at the first frame should already know the argument.
- **The sequence.** The frames, in the order you would talk through them. This is most of the page.
- **What the drawing settles, and what it does not.** Two short lists: the decisions the frames have already made and are asking to be accepted, and the ones still genuinely open. Without this a wireframe gets agreed to in full or argued with in full, and neither was wanted.
- **Reading these.** What is real copy and what is placeholder, what is deliberately not drawn, the annotation legend, and anything measured from a real screen rather than invented.
