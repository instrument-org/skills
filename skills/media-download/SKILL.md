---
name: media-download
description: "Download video, audio, captions, and metadata from web links with yt-dlp. Use when a task needs media from a URL, such as YouTube or a podcast, on disk."
