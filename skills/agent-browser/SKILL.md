---
name: agent-browser
description: Automate a real browser: open sites, click, fill forms, log in, take screenshots, and scrape pages. Use for any task that has to interact with a website.
---
