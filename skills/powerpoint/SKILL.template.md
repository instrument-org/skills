---
name: powerpoint
description: "Read, create, and edit PowerPoint presentations (.pptx), including decks built from templates."
---
...
output = Path("quarterly-review.pptx")
